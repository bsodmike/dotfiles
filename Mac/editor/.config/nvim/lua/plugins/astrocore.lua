	...
	opts = {
		...
		mappings = {
			n = {
				...
				["<C-h>"] = { ":ToggleTerm size=30 direction=horizontal<cr>", desc = "Toggle terminal" },
				...
				["<Leader>c"] = { "<cmd>w !wl-copy<cr>", desc = "Copy to buffer" },
				["<Leader>p"] = { "<cmd>read !wl-paste<cr>", desc = "Paste from buffer" },
				--[[
				["<Leader>s"] = {
					function()
